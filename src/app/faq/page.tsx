...
export const metadata: Metadata = {
  title: 'FAQ | Bizilla Studio',
  description: 'Frequently asked questions about Bizilla Studio products, orders, and services.',
};
  ...
  return (
    <div className="container legal-page">
      ...
      <div style={{ marginBottom: '3rem' }}>
        ...
        <p>All Bizilla pieces are designed in Berlin and manufactured by artisan partners across Europe who share our commitment to quality and sustainability.</p>
        
        <h3 style={{ fontSize: '1rem', fontWeight: 500, marginBottom: '0.5rem', marginTop: '1.5rem' }}>Do you offer a warranty?</h3>
        <p>Yes, all Bizilla products come with a 2-year extended warranty covering manufacturing defects.</p>
      </div>
